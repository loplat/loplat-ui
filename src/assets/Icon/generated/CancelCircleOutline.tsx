...
import Svg from '../../svg';
export const CancelCircleOutline = React.memo<IconProps>(
      ...
      >
        <defs>
          <path
            ...
            id={`cancel_circle_outline_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`cancel_circle_outline_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#cancel_circle_outline_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#cancel_circle_outline_svg__b__${uniqueId})`}>
