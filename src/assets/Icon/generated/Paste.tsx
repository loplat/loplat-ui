...
export const Paste = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="paste_svg__b" fill="#fff">
        <use xlinkHref="#paste_svg__a" />
      </mask>
      <g mask="url(#paste_svg__b)">
