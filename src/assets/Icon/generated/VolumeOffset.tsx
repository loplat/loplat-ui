...
export const VolumeOffset = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="volume_offset_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="volume_offset_svg__b" fill="#fff">
        <use xlinkHref="#volume_offset_svg__a" />
      </mask>
      <g mask="url(#volume_offset_svg__b)">
