...
export const Alert = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="alert_svg__b" fill="#fff">
        <use xlinkHref="#alert_svg__a" />
      </mask>
      <g mask="url(#alert_svg__b)">
