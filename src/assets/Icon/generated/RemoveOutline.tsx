...
export const RemoveOutline = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="remove_outline_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="remove_outline_svg__b" fill="#fff">
        <use xlinkHref="#remove_outline_svg__a" />
      </mask>
      <g mask="url(#remove_outline_svg__b)">
