...
export const DoneAll = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 8)" fill="none" fillRule="evenodd">
      <mask id="done_all_svg__b" fill="#fff">
        <use xlinkHref="#done_all_svg__a" />
      </mask>
      <g mask="url(#done_all_svg__b)">
