      ...
      >
        <defs>
          <path
            ...
            id={`questioncircle_fill_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`questioncircle_fill_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#questioncircle_fill_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#questioncircle_fill_svg__b__${uniqueId})`}>
