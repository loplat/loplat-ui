...
export const ChartPie = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="chart_pie_svg__b" fill="#fff">
        <use xlinkHref="#chart_pie_svg__a" />
      </mask>
      <g mask="url(#chart_pie_svg__b)">
