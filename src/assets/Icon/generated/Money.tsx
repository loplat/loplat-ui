...
export const Money = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 5)" fill="none" fillRule="evenodd">
      <mask id="money_svg__b" fill="#fff">
        <use xlinkHref="#money_svg__a" />
      </mask>
      <g mask="url(#money_svg__b)">
