...
export const File = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(5 2)" fill="none" fillRule="evenodd">
      <mask id="file_svg__b" fill="#fff">
        <use xlinkHref="#file_svg__a" />
      </mask>
      <g mask="url(#file_svg__b)">
