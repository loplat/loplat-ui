...
export const EmojiEvent = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="emoji_event_svg__a"
      />
    </defs>
    <g transform="translate(2 3)" fill="none" fillRule="evenodd">
      <mask id="emoji_event_svg__b" fill="#fff">
        <use xlinkHref="#emoji_event_svg__a" />
      </mask>
      <g mask="url(#emoji_event_svg__b)">
