...
export const WarningCircleOutline = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="warning_circle_outline_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="warning_circle_outline_svg__b" fill="#fff">
        <use xlinkHref="#warning_circle_outline_svg__a" />
      </mask>
      <g mask="url(#warning_circle_outline_svg__b)">
