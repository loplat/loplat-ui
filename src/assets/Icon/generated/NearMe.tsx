...
export const NearMe = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="near_me_svg__b" fill="#fff">
        <use xlinkHref="#near_me_svg__a" />
      </mask>
      <g mask="url(#near_me_svg__b)">
