...
export const RecOn = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 6)" fill="none" fillRule="evenodd">
      <mask id="rec_on_svg__b" fill="#fff">
        <use xlinkHref="#rec_on_svg__a" />
      </mask>
      <g mask="url(#rec_on_svg__b)">
