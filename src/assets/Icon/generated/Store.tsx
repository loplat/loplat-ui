...
export const Store = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 4)" fill="none" fillRule="evenodd">
      <mask id="store_svg__b" fill="#fff">
        <use xlinkHref="#store_svg__a" />
      </mask>
      <g mask="url(#store_svg__b)">
