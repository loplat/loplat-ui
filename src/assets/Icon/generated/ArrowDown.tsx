...
export const ArrowDown = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="arrow_down_svg__a"
      />
    </defs>
    <g transform="translate(2.001 2.001)" fill="none" fillRule="evenodd">
      <mask id="arrow_down_svg__b" fill="#fff">
        <use xlinkHref="#arrow_down_svg__a" />
      </mask>
      <g mask="url(#arrow_down_svg__b)">
