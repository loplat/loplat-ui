...
export const VolumeOff = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 7)" fill="none" fillRule="evenodd">
      <mask id="volume_off_svg__b" fill="#fff">
        <use xlinkHref="#volume_off_svg__a" />
      </mask>
      <g mask="url(#volume_off_svg__b)">
