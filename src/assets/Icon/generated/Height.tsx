...
export const Height = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(9 2)" fill="none" fillRule="evenodd">
      <mask id="height_svg__b" fill="#fff">
        <use xlinkHref="#height_svg__a" />
      </mask>
      <g mask="url(#height_svg__b)">
