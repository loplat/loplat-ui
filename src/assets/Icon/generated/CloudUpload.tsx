...
export const CloudUpload = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="cloud_upload_svg__a"
      />
    </defs>
    <g transform="translate(2 4)" fill="none" fillRule="evenodd">
      <mask id="cloud_upload_svg__b" fill="#fff">
        <use xlinkHref="#cloud_upload_svg__a" />
      </mask>
      <use fill={fillColor} fillRule="nonzero" xlinkHref="#cloud_upload_svg__a" />
      <g mask="url(#cloud_upload_svg__b)">
