...
export const ShoppingBag = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="shopping_bag_svg__a"
      />
    </defs>
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="shopping_bag_svg__b" fill="#fff">
        <use xlinkHref="#shopping_bag_svg__a" />
      </mask>
      <g mask="url(#shopping_bag_svg__b)">
