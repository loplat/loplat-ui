...
export const Width = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 9)" fill="none" fillRule="evenodd">
      <mask id="width_svg__b" fill="#fff">
        <use xlinkHref="#width_svg__a" />
      </mask>
      <g mask="url(#width_svg__b)">
