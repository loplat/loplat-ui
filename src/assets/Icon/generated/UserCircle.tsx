...
export const UserCircle = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="user_circle_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="user_circle_svg__b" fill="#fff">
        <use xlinkHref="#user_circle_svg__a" />
      </mask>
      <g mask="url(#user_circle_svg__b)">
