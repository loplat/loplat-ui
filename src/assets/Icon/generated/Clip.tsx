...
export const Clip = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(3 2)" fill="none" fillRule="evenodd">
      <mask id="clip_svg__b" fill="#fff">
        <use xlinkHref="#clip_svg__a" />
      </mask>
      <g mask="url(#clip_svg__b)">
