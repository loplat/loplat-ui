...
export const Card = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 5)" fill="none" fillRule="evenodd">
      <mask id="card_svg__b" fill="#fff">
        <use xlinkHref="#card_svg__a" />
      </mask>
      <g mask="url(#card_svg__b)">
