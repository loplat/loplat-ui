...
export const CloudDownload = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="cloud_download_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="cloud_download_svg__b" fill="#fff">
        <use xlinkHref="#cloud_download_svg__a" />
      </mask>
      <g mask="url(#cloud_download_svg__b)">
