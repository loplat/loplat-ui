...
export const UnfoldMore = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(6 2)" fill="none" fillRule="evenodd">
      <mask id="unfold_more_svg__b" fill="#fff">
        <use xlinkHref="#unfold_more_svg__a" />
      </mask>
      <g mask="url(#unfold_more_svg__b)" fillRule="nonzero">
