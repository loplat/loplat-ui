      ...
      >
        <defs>
          <path
            ...
            id={`checkcircle_outline_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`checkcircle_outline_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#checkcircle_outline_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#checkcircle_outline_svg__b__${uniqueId})`}>
