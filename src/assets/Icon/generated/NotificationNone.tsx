...
export const NotificationNone = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="notification_none_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="notification_none_svg__b" fill="#fff">
        <use xlinkHref="#notification_none_svg__a" />
      </mask>
      <g mask="url(#notification_none_svg__b)">
