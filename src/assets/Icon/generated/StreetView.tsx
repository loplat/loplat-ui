...
export const StreetView = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="street_view_svg__a"
      />
    </defs>
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="street_view_svg__b" fill="#fff">
        <use xlinkHref="#street_view_svg__a" />
      </mask>
      <g mask="url(#street_view_svg__b)">
