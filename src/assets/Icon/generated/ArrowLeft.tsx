...
export const ArrowLeft = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2.001 2)" fill="none" fillRule="evenodd">
      <mask id="arrow_left_svg__b" fill="#fff">
        <use xlinkHref="#arrow_left_svg__a" />
      </mask>
      <g mask="url(#arrow_left_svg__b)">
