...
import Svg from '../../svg';
export const NotificationNew = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', suffixForId, ...props }) => {
    ...
    >
      <defs>
        <path
          ...
          id={`notification_new_svg__a__${uniqueId}`}
        />
      </defs>
      <g fill="none" fillRule="evenodd">
        <g transform="translate(2 2)">
          <mask id={`notification_new_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#notification_new_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#notification_new_svg__b__${uniqueId})`}>
