      ...
      >
        <defs>
          <path
            ...
            id={`cancelcircle_outline_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`cancelcircle_outline_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#cancelcircle_outline_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#cancelcircle_outline_svg__b__${uniqueId})`}>
