...
export const Diamond = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(0 2)" fill="none" fillRule="evenodd">
      <mask id="diamond_svg__b" fill="#fff">
        <use xlinkHref="#diamond_svg__a" />
      </mask>
      <g mask="url(#diamond_svg__b)">
