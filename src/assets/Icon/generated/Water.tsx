...
export const Water = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(5 2)" fill="none" fillRule="evenodd">
      <mask id="water_svg__b" fill="#fff">
        <use xlinkHref="#water_svg__a" />
      </mask>
      <g mask="url(#water_svg__b)">
