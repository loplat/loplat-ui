...
export const ThumbUp = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="thumb_up_svg__b" fill="#fff">
        <use xlinkHref="#thumb_up_svg__a" />
      </mask>
      <g mask="url(#thumb_up_svg__b)">
