...
export const ZoomIn = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="zoom_in_svg__b" fill="#fff">
        <use xlinkHref="#zoom_in_svg__a" />
      </mask>
      <g mask="url(#zoom_in_svg__b)">
