      ...
      >
        <defs>
          <path
            ...
            id={`checkcircle_fill_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`checkcircle_fill_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#checkcircle_fill_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#checkcircle_fill_svg__b__${uniqueId})`}>
