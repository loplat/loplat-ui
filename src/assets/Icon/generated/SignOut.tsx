...
export const SignOut = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 3)" fill="none" fillRule="evenodd">
      <mask id="sign_out_svg__b" fill="#fff">
        <use xlinkHref="#sign_out_svg__a" />
      </mask>
      <g mask="url(#sign_out_svg__b)">
