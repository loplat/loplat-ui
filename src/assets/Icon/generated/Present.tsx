...
export const Present = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(1 2)" fill="none" fillRule="evenodd">
      <mask id="present_svg__b" fill="#fff">
        <use xlinkHref="#present_svg__a" />
      </mask>
      <g mask="url(#present_svg__b)">
