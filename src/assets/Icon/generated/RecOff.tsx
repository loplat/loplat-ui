...
export const RecOff = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(0 3)" fill="none" fillRule="evenodd">
      <mask id="rec_off_svg__b" fill="#fff">
        <use xlinkHref="#rec_off_svg__a" />
      </mask>
      <g mask="url(#rec_off_svg__b)">
