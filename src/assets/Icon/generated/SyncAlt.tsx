...
export const SyncAlt = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="sync_alt_svg__b" fill="#fff">
        <use xlinkHref="#sync_alt_svg__a" />
      </mask>
      <g mask="url(#sync_alt_svg__b)">
