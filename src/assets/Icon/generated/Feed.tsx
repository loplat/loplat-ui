...
export const Feed = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2.028 5.002)" fill="none" fillRule="evenodd">
      <mask id="feed_svg__b" fill="#fff">
        <use xlinkHref="#feed_svg__a" />
      </mask>
      <g mask="url(#feed_svg__b)">
