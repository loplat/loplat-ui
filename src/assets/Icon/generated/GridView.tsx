...
export const GridView = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="grid_view_svg__b" fill="#fff">
        <use xlinkHref="#grid_view_svg__a" />
      </mask>
      <g mask="url(#grid_view_svg__b)">
