...
export const VolumeOn = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 6)" fill="none" fillRule="evenodd">
      <mask id="volume_on_svg__b" fill="#fff">
        <use xlinkHref="#volume_on_svg__a" />
      </mask>
      <g mask="url(#volume_on_svg__b)">
