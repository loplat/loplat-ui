...
export const PeopleAlt = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="people_alt_svg__a"
      />
    </defs>
    <g transform="translate(1 3)" fill="none" fillRule="evenodd">
      <mask id="people_alt_svg__b" fill="#fff">
        <use xlinkHref="#people_alt_svg__a" />
      </mask>
      <g mask="url(#people_alt_svg__b)">
