...
import Svg from '../../svg';
export const Download2 = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', suffixForId, ...props }) => {
    ...
    >
      <defs>
        <path
          ...
          id={`download_2_svg__a__${uniqueId}`}
        />
      </defs>
      <g fill="none" fillRule="evenodd">
        <path stroke={fillColor} strokeWidth={2} strokeLinecap="round" d="M6 29.5h20" />
        <g transform="translate(2.001 2.001)">
          <mask id={`download_2_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#download_2_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#download_2_svg__b__${uniqueId})`}>
