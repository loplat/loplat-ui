      ...
      >
        <defs>
          <path
            ...
            id={`infocircle_fill_svg__a__${uniqueId}`}
          />
        </defs>
        <g transform="translate(2 2)" fill="none" fillRule="evenodd">
          <mask id={`infocircle_fill_svg__b__${uniqueId}`} fill="#fff">
            <use xlinkHref={`#infocircle_fill_svg__a__${uniqueId}`} />
          </mask>
          <g mask={`url(#infocircle_fill_svg__b__${uniqueId})`} fillRule="nonzero">
          ...
          <g mask={`url(#infocircle_fill_svg__b__${uniqueId})`}>
