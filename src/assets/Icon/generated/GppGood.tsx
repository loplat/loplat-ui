...
export const GppGood = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="gpp_good_svg__b" fill="#fff">
        <use xlinkHref="#gpp_good_svg__a" />
      </mask>
      <g mask="url(#gpp_good_svg__b)">
