...
export const PowerSetting = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="power_setting_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="power_setting_svg__b" fill="#fff">
        <use xlinkHref="#power_setting_svg__a" />
      </mask>
      <g mask="url(#power_setting_svg__b)">
