...
export const ArrowRight = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2.002 2)" fill="none" fillRule="evenodd">
      <mask id="arrow_right_svg__b" fill="#fff">
        <use xlinkHref="#arrow_right_svg__a" />
      </mask>
      <g mask="url(#arrow_right_svg__b)" fillRule="nonzero">
