...
export const LockOpen = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="lock_open_svg__b" fill="#fff">
        <use xlinkHref="#lock_open_svg__a" />
      </mask>
      <g mask="url(#lock_open_svg__b)">
