...
export const Bedtime = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="bedtime_svg__b" fill="#fff">
        <use xlinkHref="#bedtime_svg__a" />
      </mask>
      <g mask="url(#bedtime_svg__b)">
