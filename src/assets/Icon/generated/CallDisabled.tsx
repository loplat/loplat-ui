...
export const CallDisabled = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <defs>
      <path
        ...
        id="call_disabled_svg__a"
      />
    </defs>
    <g transform="translate(2 2)" fill="none" fillRule="evenodd">
      <mask id="call_disabled_svg__b" fill="#fff">
        <use xlinkHref="#call_disabled_svg__a" />
      </mask>
      <g mask="url(#call_disabled_svg__b)">
