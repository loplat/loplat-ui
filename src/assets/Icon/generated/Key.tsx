...
export const Key = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 4)" fill="none" fillRule="evenodd">
      <mask id="key_svg__b" fill="#fff">
        <use xlinkHref="#key_svg__a" />
      </mask>
      <g mask="url(#key_svg__b)">
