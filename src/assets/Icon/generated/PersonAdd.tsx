...
export const PersonAdd = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(1 3)" fill="none" fillRule="evenodd">
      <mask id="person_add_svg__b" fill="#fff">
        <use xlinkHref="#person_add_svg__a" />
      </mask>
      <g mask="url(#person_add_svg__b)">
