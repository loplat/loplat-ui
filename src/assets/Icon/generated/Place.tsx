...
export const Place = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(5 2)" fill="none" fillRule="evenodd">
      <mask id="place_svg__b" fill="#fff">
        <use xlinkHref="#place_svg__a" />
      </mask>
      <g mask="url(#place_svg__b)">
