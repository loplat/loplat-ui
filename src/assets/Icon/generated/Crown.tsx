...
export const Crown = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 6)" fill="none" fillRule="evenodd">
      <mask id="crown_svg__b" fill="#fff">
        <use xlinkHref="#crown_svg__a" />
      </mask>
      <g mask="url(#crown_svg__b)">
