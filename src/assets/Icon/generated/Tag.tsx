...
export const Tag = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(3 3)" fill="none" fillRule="evenodd">
      <mask id="tag_svg__b" fill="#fff">
        <use xlinkHref="#tag_svg__a" />
      </mask>
      <g mask="url(#tag_svg__b)">
