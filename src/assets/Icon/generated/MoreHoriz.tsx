...
export const MoreHoriz = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(2 13)" fill="none" fillRule="evenodd">
      <mask id="more_horiz_svg__b" fill="#fff">
        <use xlinkHref="#more_horiz_svg__a" />
      </mask>
      <g mask="url(#more_horiz_svg__b)">
