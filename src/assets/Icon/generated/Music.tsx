...
export const Music = React.memo<IconProps>(({ size = 18, fillColor = '#9DAAB7', className, style }) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <g transform="translate(4 2)" fill="none" fillRule="evenodd">
      <mask id="music_svg__b" fill="#fff">
        <use xlinkHref="#music_svg__a" />
      </mask>
      <g mask="url(#music_svg__b)">
