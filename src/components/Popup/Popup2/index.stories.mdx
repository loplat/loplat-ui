...
import { LanguageIcon, CheckCircleOutlineIcon, WarningCircleOutlineIcon } from '../../../assets/Icon';
...
<Story
  ...
  args={{
    ...
    rightButtonVariant: 'danger1',
    leftButtonVariant: 'danger2',
    children:
...
<Story
  ...
  args={{
    ...
    rightButtonLabel: '오른쪽',
    rightButtonVariant: 'primary2',
    title:
      '딴은 하나에 별 별이 패, 했던 별들을 자랑처럼 까닭입니다. 하나에 다 가을로 가난한 내일 이름자 차 소학교 까닭입니다. 풀이 내린 쓸쓸함과 멀듯이, 어머니 까닭입니다.',
    children: '새겨지는 별이 이름을 된 이웃 거외다.',
  }}
>
  {DialogTemplate.bind({})}
</Story>
