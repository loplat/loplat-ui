...
<Canvas>
  <Story name="default" args={{ label: '체크박스', checked: false, name: '기본' }}>
...
<Canvas>
  <Story name="상태">
    <Checkbox label="체크안됨" checked={false} mb={2} name="01" />
    <Checkbox label="체크" checked={true} mb={2} name="02" />
    <Checkbox label="중간값" checked="intermediate" mb={2} name="03" />
    <Checkbox label="unchecked and disabled" checked={false} disabled mb={2} name="04" />
    <Checkbox label="checked and disabled" checked={true} disabled mb={2} name="05" />
    <Checkbox label="intermediate and disabled" checked="intermediate" disabled name="06" />
  </Story>
</Canvas>
